...
const (
	...
	ChatScopeVideoLibrary  = "video_library"
)
...
type ChatSession struct {
	...
	ScopeType             string                 `gorm:"type:varchar(30);not null;default:'video';index:idx_chat_sessions_scope_knowledge_base,priority:1;check:chk_chat_sessions_scope,((scope_type = 'video' AND task_id > 0 AND knowledge_base_id = 0) OR (scope_type = 'knowledge_base' AND task_id = 0 AND knowledge_base_id > 0) OR (scope_type = 'video_library' AND task_id = 0 AND knowledge_base_id = 0))" json:"scope_type"`
